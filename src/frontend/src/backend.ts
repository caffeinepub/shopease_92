...
export class Backend implements backendInterface {
    ...
    async addToCallerCart(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addToCallerCart(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addToCart(arg0: Principal, arg1: bigint, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async clearCart(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getCallerCart(): Promise<Cart> {
        if (this.processError) {
            try {
    ...
    async getProductsFiltered(arg0: string | null): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsFiltered(to_candid_opt_n13(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeFromCallerCart(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeFromCallerCart(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeFromCart(arg0: Principal, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateCallerCartItem(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCallerCartItem(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCartItem(arg0: Principal, arg1: bigint, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
